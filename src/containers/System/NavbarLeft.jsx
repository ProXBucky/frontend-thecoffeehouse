        ...
        <div className="relative h-full">
            <div className="pt-12">
                <ul className="text-black bg-[#f5f2f0] cursor-pointer hover:text-white">
                    ...
                    <NavLink className="border-b-[#dcdcdc] border hover:bg-[#ec944a] overflow-hidden px-3 py-4 flex items-center text-base rounded-md text-black hover:text-white" activeStyle={{ background: "#f68122", color: "white" }} to="/system/manage-blog">
